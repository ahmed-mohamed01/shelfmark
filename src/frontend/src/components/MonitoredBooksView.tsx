                  ...
                  return (
                    ...
                    >
                      <MonitoredBookCompactTile
                        ...
                        showSeriesName={Boolean(seriesLabel)}
                        metaLine={metaLine}
