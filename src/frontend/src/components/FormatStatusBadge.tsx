...
export const EbookIcon = ({ className, strokeWidth = 1.5 }: { className?: string; strokeWidth?: number }) => (
...
export const AudiobookIcon = ({ className, strokeWidth = 1.5 }: { className?: string; strokeWidth?: number }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke="currentColor">
