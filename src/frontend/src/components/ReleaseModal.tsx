...
export const ReleaseModal = ({
    ...
    if (currentSort?.key === FORMAT_SORT_KEY && currentSort.value) {
      ...
      if (hasBackendScores) {
        filtered = [...filtered].sort(
          (a, b) => (getReleaseMatchScore(b) || 0) - (getReleaseMatchScore(a) || 0),
        );
      } else {
  ...
  if (embedded) {
    return (
      <div className="flex min-h-0 flex-col text-[var(--text)]">
            ...
            <div className="flex items-center justify-between px-5">
              ...
              <div className="flex items-center gap-3 pr-1 pl-2">
                ...
                <button
                  ...
                  className={`hover-surface rounded-full p-2.5 text-gray-500 transition-colors dark:text-gray-400 ${
                  ...
                  <Dropdown
                    ...
                    renderTrigger={({ isOpen, toggle }) => (
                      <button
                        type="button"
                        onClick={toggle}
                        className={`hover-surface relative rounded-full p-2.5 text-gray-500 transition-colors dark:text-gray-400 ${
                  ...
                  <Dropdown
                    ...
                    renderTrigger={({ isOpen, toggle }) => {
                      const hasLanguageFilter = !(
                        languageFilter.length === 1 && languageFilter[0] === LANGUAGE_OPTION_DEFAULT
                      );
                      const supportsIndexerFilter =
                        columnConfig.supported_filters?.includes('indexer');
                      ...
                      return (
                        <button
                          type="button"
                          onClick={toggle}
                          className={`hover-surface relative rounded-full p-2.5 text-gray-500 transition-colors dark:text-gray-400 ${isOpen ? 'bg-[var(--hover-surface)]' : ''}`}
        ...
        {showManualQuery && (
          <div className="border-b border-[var(--border-muted)] bg-[var(--bg)] px-5 py-3 sm:bg-[var(--bg-soft)]">
            <form
            ...
            >
              <input
                ...
                className="w-full rounded-lg border border-[var(--border-muted)] bg-[var(--bg)] px-3 py-2 text-sm text-[var(--text)]"
              />
              <button
                type="submit"
              ...
              {(columnConfig.action_button ||
                ...
                <div className="py-3 text-center">
                  <button
                    ...
                    className="hover-action rounded-full px-3 py-1.5 text-sm text-gray-500 transition-all duration-200 dark:text-gray-400"
                  >
        ...
        {searchStatus && searchStatus.source === activeTab && currentTabLoading && (
          <div className="pointer-events-none sticky bottom-0 z-10 flex items-center justify-center pt-2 pb-4">
            <div className="pointer-events-auto flex items-center gap-2.5 rounded-xl border border-[var(--border-muted)] bg-[var(--bg-soft)] px-4 py-2 text-sm text-gray-500 shadow-lg dark:text-gray-400">
