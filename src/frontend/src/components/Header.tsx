      ...
      <div className="flex items-center gap-2">
        ...
        {onMonitoredClick && (
          ...
          >
            ...
            <span className="hidden text-sm font-medium sm:inline">Monitoring</span>
          </button>
        )}
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {onMobileMenuClick && (
            <button
              ...
              className="hover-action relative rounded-full p-2 transition-colors sm:hidden"
            ...
            >
              ...
              {actingAsUser && (
                <span
                  className="absolute top-1 right-1 h-2 w-2 rounded-full border border-[var(--bg)] bg-sky-500"
          ...
          <button
            ...
            className={`${onMobileMenuClick ? 'hidden sm:inline-flex' : ''} hover-action relative rounded-full p-2 transition-colors ${
          ...
          {(isDropdownOpen || isClosing) &&
            ...
            createPortal(
              <div
                className={`fixed ${dropdownPanelWidthClass} z-[9999] rounded-lg border shadow-lg ${
    ...
    return (
      ...
      >
        <div className="mx-auto max-w-full px-4 py-4 sm:px-6 lg:px-8">
          ...
          {showSearch && (
            <div className="animate-pop-up flex flex-row items-center gap-3">
              {/* Logo */}
              {logoUrl && (
                <img
                  src={logoUrl}
            ...
            <div>
              <div className="flex min-h-[48px] items-center justify-between">
                <div
                  ...
                  aria-label="Home"
                >
                  {logoUrl && <img src={logoUrl} alt="Logo" className="h-8 w-8 flex-shrink-0" />}
                  <span
                ...
                {headerExtra && (
                  <div className="flex min-w-0 flex-1 justify-end">{headerExtra}</div>
                )}
                {iconButtons}
              </div>
              {/* Mobile expandable author search bar */}
              {showMobileSearchToggle && mobileSearchOpen && (
                <div className="animate-pop-up mt-2 sm:hidden">
                  <div
